...
const PropertyList = (props)=>{
  ...
  return(
    props.path === 'All' && parseInt(sellerId) !== auth.id? null:
      <Container>
        <FilterBar 
          propertyType={propertyType} setPropertyType={setPropertyType} 
          noOfBedrooms={noOfBedrooms} setNoOfBedrooms={setNoOfBedrooms} 
          noOfBathrooms={noOfBathrooms} setNoOfBathrooms={setNoOfBathrooms} 
          tenure={tenure} setTenure={setTenure}
          minPrice={minPrice} setMinPrice={setMinPrice}
          maxPrice={maxPrice} setMaxPrice={setMaxPrice} 
          minFloorsize={minFloorsize} setMinFloorsize={setMinFloorsize} 
          maxFloorsize={maxFloorsize} setMaxFloorsize={setMaxFloorsize} 
          minPSF={minPSF} setMinPSF={setMinPSF} 
          maxPSF={maxPSF} setMaxPSF={setMaxPSF}
